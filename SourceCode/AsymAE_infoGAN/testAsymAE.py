...
def testDims_AsymAE(AsymAE_class=AsymAEinfoGAN, latent_dimensions=[100], nb_epochs=500, nb_input_channels=1, one_channel_output=True,
            AMD=False, AMD_step=1, AMD_init_step=1, add_original_images=True,
            svm=False, path_to_dir = "../AsymAE_infoGAN/", **kwargs):
...
#    else:
    ...
    for idx, d in enumerate(latent_dimensions):
        shAE = AsymAE_class(latent_dim=d, nb_input_channels=nb_input_channels, one_channel_output=one_channel_output, **kwargs)
